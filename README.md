# Дипломный проект по профессии «Инженер по тестированию» Климовой Ксении (группа QA-116)
...
3) Установить [Docker Desktop](https://www.docker.com).

### Запуск тестов

1) Клонировать репозиторий командой `git clone https://github.com/Alekir08/Diploma`;
